        ...
        <div class="container position-relative">
            ...
            <div class="row py-3 py-md-4 justify-content-between align-items-center">
                ...
                <div class="col-auto d-none d-md-block">
                    <a href="<?= home_url() ?>/cart/" class="text-white">
                        ...
                        <sup class="cart-item-count bg-white d-inline-flex justify-content-center align-items-center text-primary rounded-circle" style="height: 15px; width: 15px;"><?= WC()->cart->get_cart_contents_count(); ?></sup>
                    </a>
                </div>
            </div>
        </div>
